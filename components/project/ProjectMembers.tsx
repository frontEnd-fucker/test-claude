...
export default function ProjectMembers({
  ...
  const { data: currentUserMember, isLoading: isLoadingMember } =
    useProjectMemberByUserId(projectId, currentUser?.id || "");

  const currentUserMemberOrNull = currentUserMember || null;

  const isLoading =
    isLoadingMembers || isLoadingUser || isLoadingMember || isLoadingProject;
